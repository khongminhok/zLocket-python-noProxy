...
class zLocket:
    def __init__(self, device_token: str="", target_friend_uid: str="", num_threads: int=1, note_target: str=""):
        ...
        self.NAME_TOOL="zLocket Tool Pro - CuongbokIT"
        ...
        self.telegram='ngcuongbok'
        self.author='Cuongbok'
        self.messages=[]
        ...
        if os.name == "nt":
            os.system(
                f"title 💰 {self.NAME_TOOL} {self.VERSION_TOOL} by CuongbokIT.blogspot.com 💰"
         )
    ...
    def _input_(self, prompt_text="", section="config"):
        print(
            f"{xColor.CYAN}┌──({xColor.NEON_GREEN}root@cuongbok{xColor.CYAN})-[{xColor.PURPLE}{section}{xColor.CYAN}]")
